...
function Cars() {
  const firstName = "Jude Kajura"
  const wife = "Lillian Kajura"
    return (
      <div>
        <h1> CARS </h1>
        <input type="checkbox" id="rover" name="Rover" value="Rover" /> Rover
          <p>
            {`${firstName} ${wife} `}
          ...
          <input type="checkbox" id="merce" name="Rover" value="Toyota" />Toyota
          <p>
            Why do we use it?
            It is a long established fact that a reader will be distracted by the readable content of a page when looking at its 
            layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to 
